  ...
  const menuData = {
    ...
    גלידה: [
      ...
      },
      {
        ...
        description:
          "גביע קראנצ'י ממולא בגלידה אמריקאית רכה בטעם וניל קלאסי – שילוב של מרקם קרמי עם פריכות מושלמת בכל ביס. ניתן לשדרג עם תוספות לבחירה: רטבי שוקולד לבן/מריר, סירופ תות, מקופלת לבנה או חומה, אוראו או לוטוס טחונים, מרשמלו, סוכריות צבעוניות, בוטנים קלויים ועוד הפתעות מתוקות.",
        price: "10₪",
        image: "images/americanIceCreamWithBiscit.png",
      },
      {
        name: "מארז גלידה משפחתי",
        description:
          "מארז קלקר שומר קור, מלא בגלידה אמריקאית בטעם וניל עם תוספות צבעוניות: סירופ שוקולד, סירופ תות, עוגיות טחונות, סוכריות צבעוניות, מרשמלו ועוד. ניתן לבחור גם בטעמים נוספים מהמבחר שלנו: תות, תות סורבה, וניל-דובדבן, קינמון, ריבת חלב, שוקולד, אוראו ועוד הפתעות מתחלפות.",
        price: "45₪",
        image: "images/americanIceCreamForFamily.png",
      },
    ],
    כנאפה: [
      {
      ...
      },
      {
        ...
        description:
          "כנאפה טרייה וחמה, עשויה במקום עם גבינה עשירה וסירופ סוכר מתקתק, במרקם מושלם.",
        prices: { אישית: "20₪", זוגית: "35₪", משפחתית: "70₪" },
        image: "images/knafehNabelsia.png",
      },
      {
        name: "שבלולית אדומה",
        description:
